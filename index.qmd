...
-   If the genetic variant(s) $G$ cause the exposure ($G \rightarrow X$) and cause the outcome only through the ($G \rightarrow X \rightarrow Y$), then the exposure has a causal effect on the the outcome!
...
* **Exposure** ($X$): high-density lipoprotein cholesterol (log HDL-c)
